 ...
 */
@Mapper
@Repository("OpenGaussSimpleFileResourceInfoMapper")
public interface FileResourceInfoMapperForOpenGauss {
    ...
    @Insert("INSERT INTO file_resource_info (id,file_name,file_type,upload_time,download_times) " +
            ...
            "  END AS number " +
            "  FROM file_resource_info)," +
            "#{file_resource_info.fileName}," +
            "#{file_resource_info.fileType}," +
            "#{file_resource_info.uploadTime}," +
